...
RegisterNetEvent('vrp_holdup:circlecolor')
AddEventHandler('vrp_holdup:circlecolor', function(cops)
	if cops >= 2 then --If 2 or above online, it can be robbed. (Circle is grey) !!REMEMBER TO EDIT `cfg.cops = 2` IN cfg/holdup.lua ALSO!!
		red = 220
		green = 220
		blue = 220
	end
	if cops <= 1 then --If 1 or less online, it cannot be robbed. (Circle is red)
		red = 255
		green = 0
		blue = 0
	end
